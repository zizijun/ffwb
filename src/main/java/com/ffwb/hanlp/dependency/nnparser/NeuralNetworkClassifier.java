...
import com.ffwb.hanlp.dependency.nnparser.option.LearnOption;

import java.util.List;
import java.util.Map;

import static com.ffwb.hanlp.dependency.nnparser.util.Log.ERROR_LOG;
import static com.ffwb.hanlp.dependency.nnparser.util.Log.INFO_LOG;
