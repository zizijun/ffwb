...
public class CoreSynonymDictionary
{
    ...
    /**
     * 获取一个词的同义词（意义完全相同的，即{@link com.ffwb.hanlp.dictionary.common.CommonSynonymDictionary.SynonymItem#type}
     * == {@link com.ffwb.hanlp.corpus.synonym.Synonym.Type#EQUAL}的）列表
     * @param key
     * @return
     */
