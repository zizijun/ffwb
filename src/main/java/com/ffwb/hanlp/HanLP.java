 ...
 * </copyright>
 */
package com.ffwb.hanlp;

import com.ffwb.hanlp.corpus.dependency.CoNll.CoNLLSentence;
import com.ffwb.hanlp.corpus.io.IIOAdapter;
import com.ffwb.hanlp.dependency.nnparser.NeuralNetworkDependencyParser;
import com.ffwb.hanlp.dictionary.py.Pinyin;
import com.ffwb.hanlp.dictionary.py.PinyinDictionary;
import com.ffwb.hanlp.dictionary.ts.*;
import com.ffwb.hanlp.phrase.IPhraseExtractor;
import com.ffwb.hanlp.phrase.MutualInformationEntropyPhraseExtractor;
import com.ffwb.hanlp.seg.Segment;
import com.ffwb.hanlp.seg.Viterbi.ViterbiSegment;
import com.ffwb.hanlp.seg.common.Term;
import com.ffwb.hanlp.summary.TextRankKeyword;
import com.ffwb.hanlp.summary.TextRankSentence;
import com.ffwb.hanlp.tokenizer.StandardTokenizer;
...
public class HanLP
{
    ...
    public static final class Config
    {
        ...
        /**
         * IO适配器（默认null，表示从本地文件系统读取），实现com.ffwb.hanlp.corpus.io.IIOAdapter接口
    ...
    /**
     * 简转繁,是{@link com.ffwb.hanlp.HanLP#convertToTraditionalChinese(String)}的简称
     * @param s 简体中文
     * @return 繁体中文(大陆标准)
     */
